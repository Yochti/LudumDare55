...
{
    const string privateCode = "Xvk_dR8y6kGAUZVReFyc4wpOdnKRBom0KmEN7D6vRYxQ ";  //Key to Upload New Info
    const string publicCode = "661bdf538f40bb79a86e1f55";   //Key to download
